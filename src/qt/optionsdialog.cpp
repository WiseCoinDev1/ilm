    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ILM-light"), QVariant("light"));
    ui->theme->addItem(QString("ILM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ILM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ILM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ILM-traditional"), QVariant("trad"));
