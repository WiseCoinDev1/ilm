    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Illuminum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Illuminum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and illuminum: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Illuminum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Illuminum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Illuminum Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Illuminum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Illuminum addresses"));
    ...
    openAction->setStatusTip(tr("Open a illuminum: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Illuminum Core help message to get a list with possible Illuminum Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Illuminum Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Illuminum Core"); // default title
    ...
    // Append title to "Illuminum Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
