    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Illuminum Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Illuminum Core"));
...
All the Illuminum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ILM, 0.1 ILM, 1 ILM and 10 ILM -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://illuminumpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://illuminumpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Illuminum Core is shutting down...") + "<br /><br />" +
