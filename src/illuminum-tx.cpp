...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Illuminum Core illuminum-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  illuminum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded illuminum transaction") + "\n" +
              "  illuminum-tx [options] -create [commands]   " + _("Create hex-encoded illuminum transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded illuminum transaction
