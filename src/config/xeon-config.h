/* src/config/xeon-config.h.  Generated from xeon-config.h.in by configure.  */
/* src/config/xeon-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef XEON_CONFIG_H

#define XEON_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/xeonpay/xeon/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Xeon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Xeon Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xeoncore"
