...
This mechanism has been integrated into Bitcore-Node-Illuminum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/illuminumpay/insight-api-illuminum#web-socket-api](https://github.com/illuminumpay/insight-api-illuminum#web-socket-api)
* API: [https://github.com/illuminumpay/insight-api-illuminum#instantsend-transactions](https://github.com/illuminumpay/insight-api-illuminum#instantsend-transactions)
...
By default, the Illuminum Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Illuminum Core daemon:
