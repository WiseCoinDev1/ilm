...
Only requiring some minor changes is illuminum.cpp.
...
Changes to illuminum.cpp
----------------------
illuminum.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
