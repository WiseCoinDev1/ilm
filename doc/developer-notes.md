...
Illuminum Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Illuminum Core, where everyone uses
...
pay attention to for reviewers of Illuminum Core code.

General Illuminum Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Illuminum Core uses tinyformat, which is type safe. Leave them out to avoid confusion
